...
$ll = 'LLL:EXT:t3events_template/Resources/Private/Language/locallang_db.xlf:';
...
return [
    'ctrl' => [
        'title' => $ll . 'tx_t3eventstemplate_domain_model_eventtemplate',
        'label' => 'headline',
        'tstamp' => 'tstamp',
        'crdate' => 'crdate',
        'cruser_id' => 'cruser_id',
        ...
        'iconfile' => 'EXT:t3events_template/Resources/Public/Icons/template.svg'
    ],
    'interface' => [
    ...
    'types' => [
        '1' => [
            'showitem' => '
			    	 ...
			    	 --div--;LLL:EXT:t3events/Resources/Private/Language/locallang_db.xlf:tx_t3events_domain_model_event.tab.relations,
    ...
    'columns' => [
        ...
        'l10n_parent' => [
            ...
            'config' => [
                ...
                'foreign_table' => 'tx_t3eventstemplate_domain_model_eventtemplate',
                'foreign_table_where' => 'AND tx_t3eventstemplate_domain_model_eventtemplate.pid=###CURRENT_PID### AND tx_t3eventstemplate_domain_model_eventtemplate.sys_language_uid IN (-1,0)',
            ],
        ],
        'l10n_diffsource' => [
            'config' => [
        ...
        'headline' => [
            'exclude' => 0,
            'label' => $ll . 'tx_t3eventstemplate_domain_model_eventtemplate.headline',
            'config' => [
                'type' => 'input',
                'size' => 30,
                'eval' => 'trim,required'
        ...
        'subtitle' => [
            'exclude' => 0,
            'label' => $ll . 'tx_t3eventstemplate_domain_model_eventtemplate.subtitle',
            'config' => [
                'type' => 'input',
                'size' => 30,
                'eval' => 'trim'
        ...
        'teaser' => [
            'exclude' => 1,
            'label' => $ll . 'tx_t3eventstemplate_domain_model_eventtemplate.teaser',
            'config' => [
                'type' => 'text',
                'cols' => 40,
                'rows' => 5,
        ...
        'description' => [
            'exclude' => 0,
            'label' => $ll . 'tx_t3eventstemplate_domain_model_eventtemplate.description',
            'config' => [
                'type' => 'text',
                'cols' => 32,
                'rows' => 10,
        ...
        'keywords' => [
            'exclude' => 0,
            'label' => $ll . 'tx_t3eventstemplate_domain_model_eventtemplate.keywords',
            'config' => [
                'type' => 'text',
                'cols' => 32,
                'rows' => 5,
        ...
        'image' => [
            'exclude' => 1,
            'label' => $ll . 'tx_t3eventstemplate_domain_model_eventtemplate.image',
            'config' => [
                'type' => 'group',
                'internal_type' => 'file',
        ...
        'images' => [
            'label' => $ll . 'tx_t3eventstemplate_domain_model_eventtemplate.images',
        ...
        'files' => [
            'label' => $ll . 'tx_t3eventstemplate_domain_model_eventtemplate.files',
        ...
        'related'  => [
            'label' => $ll . 'tx_t3eventstemplate_domain_model_eventtemplate.related',
            'config' => [
                'type' => 'select',
                'noIconsBelowSelect' => '1',
                'renderType' => 'selectMultipleSideBySide',
                'foreign_table' => 'tx_t3events_domain_model_event',
                'foreign_table_where' => 'AND tx_t3events_domain_model_event.deleted != 1 AND tx_t3events_domain_model_event.sys_language_uid=###REC_FIELD_sys_language_uid###',
                'MM' => 'tx_t3eventstemplate_eventtemplate_event_mm',
        ...
        'genre' => [
            'exclude' => 1,
            'label' => $ll . 'tx_t3eventstemplate_domain_model_eventtemplate.genre',
            'config' => [
                'type' => 'select',
                'renderType' => 'selectMultipleSideBySide',
                'foreign_table' => 'tx_t3events_domain_model_genre',
                'MM' => 'tx_t3eventstemplate_eventtemplate_genre_mm',
                'size' => 10,
                'autoSizeMax' => 30,
                'maxitems' => 9999,
                'multiple' => 0,
        ...
        'venue' => [
            'exclude' => 0,
            'label' => $ll . 'tx_t3eventstemplate_domain_model_eventtemplate.venue',
            'config' => [
                'type' => 'select',
                'renderType' => 'selectMultipleSideBySide',
                'foreign_table' => 'tx_t3events_domain_model_venue',
                'MM' => 'tx_t3eventstemplate_eventtemplate_venue_mm',
                'size' => 5,
                'autoSizeMax' => 30,
                'maxitems' => 9999,
                'multiple' => 0,
        ...
        'event_type' => [
            'exclude' => 0,
            'label' => $ll . 'tx_t3eventstemplate_domain_model_eventtemplate.event_type',
            'config' => [
                'type' => 'select',
                'renderType' => 'selectSingle',
        ...
        'performances' => [
            'exclude' => 0,
            'label' => $ll . 'tx_t3eventstemplate_domain_model_eventtemplate.performances',
            'config' => [
                'type' => 'inline',
        ...
        'organizer' => [
            'exclude' => 0,
            'label' => $ll . 'tx_t3eventstemplate_domain_model_eventtemplate.organizer',
            'l10n_mode' => 'mergeIfNotBlank',
            'config' => [
                'type' => 'group',
                'internal_type' => 'db',
        ...
        'audience' => [
            'exclude' => 1,
            'label' => $ll . 'tx_t3eventstemplate_domain_model_eventtemplate.audience',
            'config' => [
                'type' => 'select',
                'renderType' => 'selectMultipleSideBySide',
                'foreign_table' => 'tx_t3events_domain_model_audience',
                'MM' => 'tx_t3eventstemplate_eventtemplate_audience_mm',
                'size' => 10,
                'autoSizeMax' => 30,
                'maxitems' => 9999,
                'multiple' => 0,
        ...
        'new_until' => [
            'exclude' => 1,
            'label' => $ll . 'tx_t3eventstemplate_domain_model_eventtemplate.new_until',
            'config' => [
                'type' => 'input',
                'size' => '10',
                'max' => '20',
        ...
        'archive_date' => [
            'exclude' => 1,
            'label' => $ll . 'tx_t3eventstemplate_domain_model_eventtemplate.archive_date',
            'config' => [
                'type' => 'input',
                'size' => '10',
                'max' => '20',
        ...
        'content_elements' => [
            'exclude' => 0,
            'label' => $ll . 'tx_t3eventstemplate_domain_model_eventtemplate.content_elements',
            'config' => [
                'type' => 'inline',
                'foreign_table' => 'tt_content',
                'foreign_field' => 'tx_t3eventstemplate_eventtemplate',
                'maxitems' => 99,
                'appearance' => [
                    'collapseAll' => 1,
